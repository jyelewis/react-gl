...
// TODO: could we do this as a shader instead?
// Mapbox does this - https://github.com/mapbox/mapbox-gl-js/blob/8826bc0dc119a86c0ca19976dcdd31b997fe96ad/src/shaders/_prelude_terrain.vertex.glsl#L102
...
export function pointsToMesh(points: NdArray<Uint32Array>): Mesh {
  ...
  for (let x = 0; x < width; x++) {
    for (let y = 0; y < height; y++) {
      ...
      vertices[vertexIndex++] = points.get(x, y, 2) * 0.5;
